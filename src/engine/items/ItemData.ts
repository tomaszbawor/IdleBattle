...
import Item, { ItemRarity, ItemEffect, ItemTypes, ItemRarities, EquipmentSlots } from './Item';
...
export const Consumables: Record<string, Item> = {
  HEALTH_POTION: new Item({
    ...
    slot: EquipmentSlots.WEAPON, // Consumables don't have a slot, but it's required by the interface
    rarity: ItemRarities.COMMON,
    level: 1,
    value: 20,
