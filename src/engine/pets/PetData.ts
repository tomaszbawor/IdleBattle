// PetData.ts - Data for different pet types
...
interface PetSkill {
  ...
  level: number;
  getSetArray: () => number[];
  effect: (pet: any, target: any) => EffectResult;
}
...
// Pet skills
export const PetSkills: Record<string, PetSkill> = {
  BITE: {
    id: 'pet_bite',
    name: 'Bite',
...
export const getPetById = (id: string): PetType => {
